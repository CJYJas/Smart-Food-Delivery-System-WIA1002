...
public class App {
    ...
    static final String RESTAURANTS_FILE = "data/restaurants.csv";
    static final String MENU_FILE = "data/menu.csv";
    static final String LOCATIONS_FILE = "data/locations.csv";
    static final String ROADS_FILE = "data/roads.csv";
    static final String RIDERS_FILE = "data/riders.csv";
    ...
    public static void main(String[] args) {
        ...
        while (running) {
            ...
            switch (choice) {
                ...
                case "3" -> User.signup(scanner, userManager);
                case "0" -> {
                    running = false;
                    printHeader("GOODBYE");
